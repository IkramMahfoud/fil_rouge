        ...
        <div class="bg-white shadow rounded overflow-hidden">
            <div class="px-4 pt-5 pb-1 background">
                <div class="media align-items-end profile-header">
                    <div class="profile mr-3"><img src="<?= URLROOT . 'img/' . $data['info']->avatar ?>" width="130" class="rounded mb-2 img-thumbnail">

                    <!-- //////////////////////////////////// -->
                    <!-- ghay3adel ghi l'artist mol portfolio -->
                    <?php if(!empty($_SESSION['user_id']) && $_SESSION['user_id'] == $data['info']->user_id) : ?>
                    <a href="<?= URLROOT ?>portfolioController/edit_profile" class="btn btn-dark btn-sm btn-block">Edit profile</a>
                    <?php endif?>
            ...
            <div class="bg-light p-5 d-flex justify-content-end text-center position-relative">
                <p class="position-absolute top-0 start-0 mt-2 mx-4 fs-5"><b>About</b></p>
                <p class="position-absolute top-0 start-0 mt-5 mx-4 fs-5"><?= $data['info']->descreption ?></p>
            </div>
            ...
            <div class="py-4 px-4">
                <div class="d-flex align-items-center justify-content-between mb-3 text-text">
                    ...
                    <?php if(!empty($_SESSION['user_id']) && $_SESSION['user_id'] == $data['info']->user_id) : ?>
                    <a href="<?= URLROOT ?>artworkController/add_artwork" class="btn btn-link text-muted txm">add from here</a>
                    <?php endif?>
                </div>

                <div class="row mb-5">
                    <?php foreach ($data['artworks'] as $artwork) : ?>
                        <div class="col-lg-3 mb-2 pr-lg-1 divImageArtWork mt-0 mx-4">
                            <img src="  <?= URLROOT ?>img/<?= $artwork->image ?>" alt="" class="img-fluid  shadow-sm p_i">
                            <!-- TITLE --><!-- PRICE HERE --><!-- CATEGORY -->
